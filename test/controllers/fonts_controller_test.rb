...
class FontsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create font" do
    assert_difference('Font.count') do
      post fonts_url, params: { font: { description: @font.description, name: @font.name, picture: @font.picture } }
    end
  ...
  test "should update font" do
    patch font_url(@font), params: { font: { description: @font.description, name: @font.name, picture: @font.picture } }
